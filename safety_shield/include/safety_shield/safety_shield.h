...
class SafetyShield {
 private:
  ...
  /**
   * @brief forces the sara_shield to be safe. Useful for testing.
   */
  bool force_safe_ = false;

  /**
   * @brief forces the sara_shield to be unsafe. Useful for testing.
   */
 ...
 public:
   ...
   * @param msg (bool) True: Never stop the robot, False: Normal operation
   */
